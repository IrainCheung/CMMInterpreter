...
class SyntaxHighlighter implements DocumentListener {
	...
	public SyntaxHighlighter(JTextPane editor) {
		...
		Color keyWordColor=new Color(0, 0, 192);
		Color symbolColor=new Color(227, 106, 13);
		StyleConstants.setForeground(keywordStyle, keyWordColor);
		StyleConstants.setForeground(normalStyle, Color.BLACK);
		StyleConstants.setForeground(symbolStyle, symbolColor);
		// 准备关键字
...
//		System.out.println("输出所有的单词============="+word);
		if (keywords.contains(word)) {
			...
			SwingUtilities.invokeLater(new ColouringTask(doc, pos, wordEnd - pos, symbolStyle));
		}
